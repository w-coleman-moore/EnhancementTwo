// OriginalCodeAlgorithms.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
using namespace std;
	...
	void database()
	{
		...
		char *password;
		char *pass = "codewithc";
		password = lg.getpass("Enter the admininistrator password:");
		detail a;
		fstream f;
		int ch;
		char c;
	...
	void user()
	{
		...
		puts("Enter your id:");
		gets(id);
		password = a.getpass("Enter your password:");
		while (f.read((char *)& a, sizeof(a)))
		{
